<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetici/Admin.master" AutoEventWireup="true" CodeFile="Menu.aspx.cs" Inherits="Yonetici_Menu" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="maincontent">
        	<div class="contentinner">
             	<h4 class="widgettitle">Menü Ayarları</h4>
                	...
                	<%--<form id=form1 runat="server" class="stdform">--%>
                        <p>
                            ...
                            <td><asp:ListBox ID="ListBox1" CssClass="span4" runat="server" AutoPostBack="False" 
                                ...
                                <td>
                                    <asp:Image ID="Image1" runat="server" Height="120" Width="200" />
                                    <asp:Repeater ID="Repeater1" runat="server">
                                        <ItemTemplate>
                                     <br />
                                    <asp:Label ID="Label1" runat="server" Text='<%#String.Format("{0:C}",Eval("Fiyat")) %>' Font-Bold="True" Font-Size="X-Large"></asp:Label>
                                        </ItemTemplate>
                                    </asp:Repeater>
    ...
    <h4 class="widgettitle">Menü Listesi</h4>
                          ...
                          <td class="aligncenter"><span class="center">
                            ...
                            <td>
                                            ...
                                            <ul class="dropdown-menu">
                                              ...
                                              <li class="divider"></li>
                                              <li><a href="Menu.aspx?Sil=<%#Eval("MenuID") %>"><i class="iconsweets-denied"></i> &nbsp;Sil</a></li>
                                            </ul>
                                        </div>
                            </td>
                        </tr>
